...
"
      >
        ...
        <div className="flex items-center max-w-[800px] mx-auto max-[1256px]:hidden">
          <div>
            <Translate />
          </div>
...
`}
        ...
        <div className="flex items-center justify-center min-[1800px]:ml-40">
          ...
          <Button className="w-[55px]! h-[55px]! p-2! sm:p-3! bg-transparent! ml-1! sm:ml-[0.2rem]! mr-3! sm:mr-[1.2rem]!">
            <svg
          ...
          <Button
            onClick={close}
            className="bg-[#fd0]! w-12.5! h-12.5! rounded-4xl! p-2! flex! items-center! justify-center!"
          >
